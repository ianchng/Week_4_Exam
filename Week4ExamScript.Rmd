...
!CAUTION! - CSV file country names have a space in front of it which you have to remove. Otherwise, the join will not work. Use the deplyr mutate function to remove all leading and trailling spaces with the str_trim function
